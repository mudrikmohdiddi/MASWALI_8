...
print(f"The average monthly rainfall is {total_rain/len(month)}")
print(f"The highest rain full is {high_rain} at {high_month}")
print(f"The lowest rain full is {lower_rain} at {lower_month}")
